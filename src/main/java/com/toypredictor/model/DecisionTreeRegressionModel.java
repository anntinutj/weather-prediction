 ...
 *
 */
public class DecisionTreeRegressionModel implements AbstractModel, Serializable {

	private static final long serialVersionUID = 1177599644173975701L;

	private final static Logger logger = Logger.getLogger(DecisionTreeRegressionModel.class);
	...
	public Double evaluateModel(JavaRDD<LabeledPoint> testDataSet) throws WeatherPredictionException {
		...
		Double testMSE = new JavaDoubleRDD(predictionAndLabel.map(new Function<Tuple2<Double, Double>, Object>() {
